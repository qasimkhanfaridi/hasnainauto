...
export const InstallationTrust: React.FC = () => {
  ...
  return (
    <section className="py-16 sm:py-20 bg-carbon-950 border-b border-white/5 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-12">
          {steps.map((s, idx) => (
            <div
              key={idx}
              className="p-5 rounded-2xl bg-carbon-900 border border-white/5 hover:border-amber-brand/40 transition-all flex flex-col justify-between space-y-4 group"
            >
              ...
              <div>
                <h3 className="text-sm font-bold text-white uppercase tracking-wide group-hover:text-amber-brand transition-colors">
                  {s.title}
                </h3>
        ...
        <div className="rounded-3xl bg-gradient-to-r from-carbon-900 via-carbon-850 to-carbon-900 border border-white/10 p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 shrink-0">
            <a
              ...
              className="px-6 py-3.5 rounded-xl bg-whatsapp hover:bg-whatsapp-hover text-carbon-950 font-black text-xs uppercase tracking-wider flex items-center gap-2 shadow-whatsapp-glow transition-all"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-5 py-3.5 rounded-xl bg-carbon-800 hover:bg-carbon-750 text-white font-bold text-xs uppercase tracking-wider flex items-center gap-2 border border-white/10 transition-colors"
            >
