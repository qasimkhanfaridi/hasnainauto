    ...
    <section className="section-padding bg-grey-light">
      <div className="max-w-4xl mx-auto text-center px-4">
        ...
        <p className="text-grey-text text-lg mb-8 max-w-2xl mx-auto">
          Premium accessories, custom fitting, and hassle-free COD delivery across Pakistan.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/category/seat-covers" className="px-8 py-3.5 btn-gold text-base uppercase tracking-wide">
            Shop Now
          </Link>
          <WhatsAppButton
